...
QtObject {
    ...
    property int colorTheme: Colors.Theme.Mocha
    ...
    function palette() {
        switch (colorTheme) {
        case Colors.Theme.Mocha:
            return mocha;
        case Colors.Theme.Latte:
            return latte;
        }
    }

    function transparent(color: color, opacity) {
    var alpha = Math.round(opacity * 255).toString(16).padStart(2, '0').toUpperCase();
